...
public class BluetoothPrintService {
    ...
    public void write(byte[] out) {
        ...
        synchronized (this) {
            if (mState != STATE_CONNECTED) {
                ...
                Bundle bundle = new Bundle();
                bundle.putInt(AppConstant.TOAST, R.string.not_connected);
                msg.setData(bundle);
                mHandler.sendMessage(msg);
    ...
    private void connectionFailed() {
        ...
        Message msg = mHandler.obtainMessage(AppConstant.MESSAGE_TOAST);
        Bundle bundle = new Bundle();
        bundle.putInt(AppConstant.TOAST, R.string.connect_fail);
        msg.setData(bundle);
        mHandler.sendMessage(msg);
    ...
    private void connectionLost() {
        ...
        Message msg = mHandler.obtainMessage(AppConstant.MESSAGE_TOAST);
        Bundle bundle = new Bundle();
        bundle.putInt(AppConstant.TOAST, R.string.connect_lost);
        msg.setData(bundle);
        mHandler.sendMessage(msg);
        ...
        public void run() {
            ...
            while (true) {
                try {
                    ...
                    mHandler.obtainMessage(AppConstant.MESSAGE_READ, bytes, -1, rcvData).sendToTarget();
                } catch (IOException e) {
