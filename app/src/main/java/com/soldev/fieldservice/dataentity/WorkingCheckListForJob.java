...
public class WorkingCheckListForJob {
    private int rowNo;
    ...
    public WorkingCheckListForJob() {
    }

    public WorkingCheckListForJob(int rowNo, String description, boolean checkBefore, boolean checkBetween, boolean checkAfter) {
        this.rowNo = rowNo;
